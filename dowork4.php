<?php require 'common.php'; 
    ...
    if($person=='rakshit'){
        $sql='select date,testsub,marks,totalmarks from testscore where perid=1 order by date desc';
    }
    else if($person=='veer'){
        $sql='select date,testsub,marks,totalmarks from testscore where perid=2 order by date desc';
    }
...
<body>
    ...
    <div style="height:450px;width:100%;position:relative;">
        <div id="content">
         <h2 style="letter-spacing:2px;"> Test Scores</h2>
         ...
         <?php while($r=mysqli_fetch_array($result)){?>
            <div>
                <div class="date">
                 ...
                 <div class="homework">
                    <p><?php echo $r['testsub']?>-<span style="color:red;font-weight:bold;"><?php echo $r['marks'] ?>/<?php echo $r['totalmarks'] ?></span></p>
                 </div>
             </div>
         <?php } 
         if($num==0){
